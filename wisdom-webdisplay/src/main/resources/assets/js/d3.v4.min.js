...
(function(t, n) {
    ...
    function qt(t) {
        ...
        var e = Yt(t.r),
            r = Yt(t.g),
            i = Yt(t.b),
            o = Ot((.4124564 * e + .3575761 * r + .1804375 * i) / .95047),
            u = Ot((.2126729 * e + .7151522 * r + .072175 * i) / 1);
    ...
    function Xt(t) {
        ...
        var n = t.r / 255,
            e = t.g / 255,
            r = t.b / 255,
            i = ((Yl * Bl - jl * Il) * r + Hl * jl * n - Hl * Yl * e) / -5.9615122912,
            o = r - i,
            u = (Hl * (e - i) - Bl * o) / jl,
            a = Math.sqrt(u * u + o * o) / (Hl * i * (1 - i)),
            c = a ? Math.atan2(u, o) * Ol - 120 : NaN;
    ...
    function $n(t, n) {
        var e, r, i;
        return function() {
            var o = el(this).getComputedStyle(this, null),
    ...
    function Zn(t, n, e) {
        var r, i, o;
        return function() {
            var u = el(this).getComputedStyle(this, null),
    ...
    function be(t, n) {
        for (var e; !(e = t.__transition) || !(e = e[n]);)
            if (!(t = t.parentNode)) return bp.time = dn(), bp;
        return e
    }
    ...
    function ze(n) {
        function e(t) {
            ...
            }), t.selectAll(".selection").data([Me("selection")]).enter().append("rect").attr("class", "selection").attr("cursor", qp.selection).attr("fill", "#777").attr("fill-opacity", .3).attr("stroke", "#fff").attr("shape-rendering", "crispEdges");
        ...
        function u() {
            ...
            if (f.apply(this, arguments)) {
                var l, h, p, d, v, _, g, y, m, x, b, w, M, T = this,
                    ...
                    S = "selection" === (t.event.metaKey ? k = "overlay" : k) ? Ep : t.event.altKey ? zp : Cp,
                    N = n === Lp ? null : Op[k],
                    E = n === Pp ? null : Fp[k],
                    A = Se(T),
                    C = A.extent,
                ...
                "overlay" === k ? A.selection = z = [
                    [l = n === Lp ? P : D[0], p = n === Pp ? L : D[1]],
                    [v = n === Lp ? R : l, g = n === Pp ? q : p]
                ] : (l = z[0][0], p = z[0][1], v = z[1][0], g = z[1][1]), h = l, d = p, _ = v, y = g;
                var I = _l(T).attr("pointer-events", "none"),
                    Y = I.selectAll(".overlay").attr("cursor", qp[k]);
        ...
        return e.move = function(t, e) {
            ...
            emit: function(t) {
                E(new Sp(e, t, n.output(this.state.selection)), l.apply, l, [t, this.that, this.args])
            }
        }, e.extent = function(t) {
    ...
    function Je(t, n, e, r) {
        ...
        do i = i ? i[l] = new Array(4) : t._root = new Array(4), (s = n >= (o = (v + g) / 2)) ? v = o : g = o, (f = e >= (u = (_ + y) / 2)) ? _ = u : y = u; while ((l = f << 1 | s) === (h = (c >= u) << 1 | a >= o));
    ...
    function hr(t) {
        ...
        var n, e = n[1] || " ",
            ...
            s = n[8] && +n[8].slice(1),
            f = n[9] || "";
        "n" === f ? (c = !0, f = "g") : Wd[f] || (f = ""), (u || "0" === e && "=" === r) && (u = !0, e = "0", r = "="), this.fill = e, this.align = r, this.sign = i, this.symbol = o, this.zero = u, this.width = a, this.comma = c,
            this.precision = s, this.type = f
    }
    ...
    function Rr(t, n) {
        gv.push(yv = [sv = t, lv = t]), n < fv && (fv = n), n > hv && (hv = n)
    }
    ...
    function Wr(t, n) {
        ...
        var e = Xv(n),
            ...
            i = e * Gv(t),
            o = Gv(n),
            u = Hv(Qv((u = Lv * o - Rv * i) * u + (u = Rv * r - Pv * o) * u + (u = Pv * i - Lv * r) * u), Pv * r + Lv * i + Rv * o);
    ...
    function ti(t, n) {
        return [t > Uv ? t - Fv : t < -Uv ? t + Fv : t, n]
    }
    ...
    function ei(t) {
        return function(n, e) {
            return n += t, [n > Uv ? n - Fv : n < -Uv ? n + Fv : n, e]
        }
    }
    ...
    function ii(t, n) {
        function e(t, n) {
            var e = Xv(n),
                ...
                s = Gv(n),
                f = s * r + a * i;
            return [Hv(c * o - f * u, a * r - s * i), gr(f * o + c * u)]
        }
        var r = Xv(t),
            i = Gv(t),
            o = Xv(n),
        ...
        return e.invert = function(t, n) {
            var e = Xv(n),
                ...
                s = Gv(n),
                f = s * o - c * u;
            return [Hv(c * o + s * u, a * r + f * i), gr(f * r - a * i)]
        }, e
    }
    ...
    function oi(t, n, e, r, i, o) {
        if (e) {
            ...
            for (var s, f = i; r > 0 ? f > o : f < o; f -= c) s = Nr([u, -a * Xv(f), -a * Gv(f)]), t.point(s[0], s[1])
        }
    }
        ...
        return function(u) {
            ...
            function d(o, u) {
                ...
                if (_ && g.push([o, u]), T) y = o, m = u, x = a, T = !1, a && (S.lineStart(), S.point(o, u));
                    ...
                    var c = [b = Math.max(-1e9, Math.min(1e9, b)), w = Math.max(-1e9, Math.min(1e9, w))],
                        s = [o = Math.max(-1e9, Math.min(1e9, o)), u = Math.max(-1e9, Math.min(1e9, u))];
    ...
    function Gi(t, n, e) {
        ...
        t.scale(150).translate([0, 0]), null != o && t.clipExtent(null), e_(e, t.stream(Q_));
        var u = Q_.result(),
        ...
        function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
            ...
            if (m > 4 * n && v--) {
                var x = u + h,
                    ...
                    M = Qv(x * x + b * b + w * w),
                    T = gr(w /= M),
                    k = Bv(Bv(w) - 1) < 1e-6 || Bv(o - l) < 1e-6 ? (o + l) / 2 : Hv(b, x),
                    S = t(k, T),
                    N = S[0],
                    E = S[1],
                    A = N - r,
    ...
    function no(t) {
        function n(t) {
            return t = f(t[0] * Yv, t[1] * Yv), [t[0] * _ + a, c - t[1] * _]
        }

        function e(t) {
            return t = f.invert((t[0] - a) / _, (c - t[1]) / _), t && [t[0] * Iv, t[1] * Iv]
        }
        ...
        return n.stream = function(t) {
                ...
                return arguments.length ? (m = t[0] % 360 * Yv, x = t[1] % 360 * Yv, i()) : [m * Iv, x * Iv]
            }, n.rotate = function(t) {
                return arguments.length ? (b = t[0] % 360 * Yv, w = t[1] % 360 * Yv, M = t.length > 2 ? t[2] % 360 * Yv : 0, i()) : [b * Iv, w * Iv, M * Iv]
    ...
    function eo(t) {
        ...
        return i.parallels = function(t) {
            return arguments.length ? r(n = t[0] * Yv, e = t[1] * Yv) : [n * Iv, e * Iv]
        }, i
    }
    ...
    function io(t, n) {
        ...
        return e.invert = function(t, n) {
            var e = u - n;
            return [Hv(t, Bv(e)) / i * Jv(e), gr((o - (t * t + e * e) * i * i) / (2 * i))]
        }, e
    }
    ...
    function ao(t) {
        return function(n, e) {
            var r = Qv(n * n + e * e),
                i = t(r),
                o = Gv(i);
            return [Hv(n * o, r * Xv(i)), gr(r && e * o / r)]
        }
    }

    function co(t, n) {
        return [t, Wv(Kv((Dv + n) / 2))]
    }
    ...
    function lo(t, n) {
        function e(t, n) {
            ...
            var e = o / Zv(fo(n), i);
            return [e * Gv(i * t), o - e * Xv(i * t)]
        }
        var r = Xv(t),
            i = t === n ? Gv(t) : Wv(r / Xv(n)) / Wv(fo(n) / fo(t)),
            o = r * Zv(fo(t), i) / i;
        return i ? (e.invert = function(t, n) {
            var e = o - n,
                r = Jv(i) * Qv(t * t + e * e);
            return [Hv(t, Bv(e)) / i * Jv(e), 2 * jv(Zv(o / r, 1 / i)) - Dv]
        }, e) : co
    }
    ...
    function po(t, n) {
        function e(t, n) {
            var e = o - n,
                r = i * t;
            return [e * Gv(r), o - e * Xv(r)]
        }
        var r = Xv(t),
            i = t === n ? Gv(t) : (r - Xv(n)) / (n - t),
            o = r / i + t;
        return Bv(i) < 1e-6 ? ho : (e.invert = function(t, n) {
            var e = o - n;
            return [Hv(t, Bv(e)) / i * Jv(e), o - Jv(i) * Qv(t * t + e * e)]
        }, e)
    }
    ...
    function ps(t, n, e, r) {
        var i, o, u, a, c, s, f, l, h, p, d, v, _ = zb.length,
            g = !0;
        for (i = 0; i < _; ++i)
            if (o = zb[i]) {
                for (u = o.site, c = o.halfedges, a = c.length; a--;) Lb[c[a]] || c.splice(a, 1);
                for (a = 0, s = c.length; a < s;) p = ls(o, Lb[c[a]]), d = p[0], v = p[1], f = fs(o, Lb[c[++a % s]]), l = f[0], h = f[1], (Math.abs(d - l) > Ub || Math.abs(v - h) > Ub) && (c.splice(a, 0, Lb.push(rs(u, p, Math.abs(d - t) < Ub && r - v > Ub ? [t, Math.abs(l - t) < Ub ? h : r] : Math.abs(v - r) < Ub && e - d > Ub ? [Math.abs(h - r) < Ub ? l : e, r] : Math.abs(d - e) < Ub && v - n > Ub ? [e, Math.abs(l - e) < Ub ? h : n] : Math.abs(v - n) < Ub && d - t > Ub ? [Math.abs(h - n) < Ub ? l : t, n] : null)) - 1), ++s);
                s && (g = !1)
            }
        if (g) {
            var y, m, x, b = 1 / 0;
    ...
    function bs(t) {
        for (var n, e, r, i, o = t[0], u = t[1], a = Cb._; a;)
            if (r = ws(a, u) - o, r > Ub) a = a.L;
            else {
                if (i = o - Ms(a, u), !(i > Ub)) {
    ...
    function Ss(t, n) {
        ...
        for (Lb = [], zb = new Array(t.length), Cb = new Jc, Pb = new Jc;;)
            if (i = Ab, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (bs(o), e = o[0], r = o[1]), o = t.pop();
            else {
                if (!i) break;
                xs(i.arc)
            }
    ...
    var Rs = function(t, n) {
        ...
        js = function(t, n) {
            var e, r, i = t.length,
                ...
                c = 0;
            if (null == n)
                for (; ++a < i;) isNaN(e = Bs(t[a])) || (r = e - o, o += r / ++c, u += r * (e - o));
            else
                for (; ++a < i;) isNaN(e = Bs(n(t[a], a, t))) || (r = e - o, o += r / ++c, u += r * (e - o));
            if (c > 1) return u / (c - 1)
        },
        Hs = function(t, n) {
            var e = js(t, n);
        ...
        sf = function(t, n) {
            var e, r = 0,
                ...
                u = i;
            if (null == n)
                for (; ++o < i;) isNaN(e = Bs(t[o])) ? --u : r += e;
            else
                for (; ++o < i;) isNaN(e = Bs(n(t[o], o, t))) ? --u : r += e;
            if (u) return r / u
        },
        ff = function(t, n) {
            var e, r = [],
                ...
                o = -1;
            if (null == n)
                for (; ++o < i;) isNaN(e = Bs(t[o])) || r.push(e);
            else
                for (; ++o < i;) isNaN(e = Bs(n(t[o], o, t))) || r.push(e);
    ...
    var ol = function(t, n) {
        ...
        ll = function(t, n) {
            var e = "function" == typeof t ? t : kf(t),
                r = null == n ? st : "function" == typeof n ? n : Uf(n);
            return this.select(function() {
    ...
    var _l = function(t) {
        ...
        gl = function(t) {
            return "string" == typeof t ? new dt([document.querySelectorAll(t)], [document.documentElement]) : new dt([null == t ? [] : t], vl)
        },
        yl = function(t, n, e) {
            arguments.length < 3 && (e = n, n = Lf().changedTouches);
            for (var r, i = 0, o = n ? n.length : 0; i < o; ++i)
                if ((r = n[i]).identifier === e) return Rf(t, r);
            return null
        },
        ml = function(t, n) {
            null == n && (n = Lf().touches);
    ...
    var Ml = function() {
        ...
        zl = new RegExp("^rgb\\(" + [Nl, Nl, Nl] + "\\)$"),
        Pl = new RegExp("^rgba\\(" + [kl, kl, kl, Sl] + "\\)$"),
        Ll = new RegExp("^rgba\\(" + [Nl, Nl, Nl, Sl] + "\\)$"),
        Rl = new RegExp("^hsl\\(" + [Sl, Nl, Nl] + "\\)$"),
        ql = new RegExp("^hsla\\(" + [Sl, Nl, Nl, Sl] + "\\)$"),
        Ul = {
            aliceblue: 15792383,
    ...
    Tl(Vt, $t, wt(Mt, {
        ...
        rgb: function() {
            var t = isNaN(this.h) ? 0 : (this.h + 120) * Dl,
                n = +this.l,
    ...
    var Xl, $l, Vl, Wl, Zl, Gl, Jl = function(t) {
        ...
        ah = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
        ch = new RegExp(ah.source, "g"),
        sh = function(t, n) {
            var e, r, i, o = ah.lastIndex = ch.lastIndex = 0,
                u = -1,
                a = [],
                c = [];
            for (t += "", n += "";
                (e = ah.exec(t)) && (r = ch.exec(n));)(i = r.index) > o && (i = n.slice(o, i), a[u] ? a[u] += i : a[++u] = i), (e = e[0]) === (r = r[0]) ? a[u] ? a[u] += r : a[++u] = r : (a[++u] = null, c.push({
                i: u,
                x: oh(e, r)
            })), o = ch.lastIndex;
        ...
        yh = function(t, n) {
            ...
            if (h < 1e-12) r = Math.log(s / u) / gh, e = function(t) {
                return [i + t * f, o + t * l, u * Math.exp(gh * t * r)]
            };
            else {
                var p = Math.sqrt(h),
                ...
                r = (Math.log(Math.sqrt(v * v + 1) - v) - _) / gh, e = function(t) {
                    var n = t * r,
                        e = an(_),
                        a = u / (2 * p) * (e * sn(gh * n + _) - cn(_));
                    return [i + a * f, o + a * l, u * e / an(gh * n + _)]
                }
            }
        ...
        Ch = 0,
        zh = 0,
        Ph = "object" == typeof performance && performance.now ? performance : Date,
        Lh = "function" == typeof requestAnimationFrame ? requestAnimationFrame : function(t) {
            setTimeout(t, 17)
        };
    ...
    var Rh = function(t, n, e) {
        ...
        Uh = d("start", "end", "interrupt"),
        Dh = [],
        Oh = function(t, n, e, r, i, o) {
        ...
        Qh = function(t) {
            ...
            for (var r = this._groups, i = r.length, o = new Array(i), u = 0; u < i; ++u)
                for (var a, c, s = r[u], f = s.length, l = o[u] = new Array(f), h = 0; h < f; ++h)(a = s[h]) && (c = t.call(a, a.__data__, h, s)) && ("__data__" in a && (c.__data__ = a.__data__), l[h] = c, Oh(l[h], n, e, h, l, kn(a, e)));
    ...
    var cp = function t(n) {
        ...
        wp = function(t) {
            ...
            for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
                for (var u, a = r[o], c = a.length, s = 0; s < c; ++s)(u = a[s]) && Oh(u, t, n, s, a, e || be(u, n));
    ...
    var Mp = [null],
        Tp = function(t, n) {
            ...
            if (i) {
                n = null == n ? null : n + "";
                for (r in i)
                    if ((e = i[r]).state > 1 && e.name === n) return new Kn([
                        [t]
                    ], Mp, n, +r)
            }
            return null
            ...
            if (null === this._x1) this._ += "M" + (this._x1 = t) + "," + (this._y1 = n);
                ...
                if (Math.abs(f * a - c * s) > 1e-6 && i) {
                    var h = e - o,
                        ...
                        _ = Math.sqrt(d),
                        g = Math.sqrt(l),
                        y = i * Math.tan((Gp - Math.acos((d + l - v) / (2 * _ * g))) / 2),
                        m = y / g,
                        x = y / _;
    ...
    var ed = function(t) {
        ...
        Td = function(t, n, e) {
            var r, i, o, u, a, c, s, f = this._x0,
                ...
                d = [],
                v = this._root;
            for (v && d.push(new Md(v, f, l, h, p)), null == e ? e = 1 / 0 : (f = t - e, l = n - e, h = t + e, p = n + e, e *= e); c = d.pop();)
        ...
        Ed = function(t) {
            var n, e, r, i, o, u, a = [],
                c = this._root;
            for (c && a.push(new Md(c, this._x0, this._y0, this._x1, this._y1)); n = a.pop();)
    ...
    var Ld, Rd = function(t) {
        ...
        qd = function(t) {
            ...
            function e(n) {
                for (var e = 0, r = t.length; e < d; ++e)
                    for (var i, o, c, s, l, h, p, v = 0; v < r; ++v) i = t[v], o = i.source, c = i.target, s = c.x + c.vx - o.x - o.vx || yd(), l = c.y + c.vy - o.y - o.vy || yd(), h = Math.sqrt(s * s + l * l), h = (h - a[v]) / h * n * u[v], s *= h, l *= h, c.vx -= s * (p = f[v]), c.vy -= l * p, o.vx += s * (p = 1 - p), o.vy += l * p
            }
        ...
        $d = function(t, n) {
            ...
            var r = e[0],
                i = e[1],
                o = i - (Ld = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1,
                u = r.length;
    ...
    var Gd, Jd = function(t) {
        ...
        Qd = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"],
        Kd = function(t) {
            function n(t) {
                function n(t) {
                    var n, i, s, m = v,
            ...
            var r = t.grouping && t.thousands ? jd(t.grouping, t.thousands) : Jd,
                i = t.currency,
                o = t.decimal,
                u = t.numerals ? Hd(t.numerals) : Jd;
            return {
                format: n,
                formatPrefix: e
            }
    ...
    var iv, ov, uv, av, cv, sv, fv, lv, hv, pv, dv, vv, _v, gv, yv, mv, xv, bv, wv, Mv, Tv, kv, Sv, Nv, Ev, Av, Cv, zv, Pv, Lv, Rv, qv = new dr,
        Uv = Math.PI,
        Dv = Uv / 2,
        Ov = Uv / 4,
        Fv = 2 * Uv,
        ...
        s_ = function(t) {
            ...
            if (hv = lv = -(sv = fv = 1 / 0), gv = [], e_(t, c_), e = gv.length) {
                for (gv.sort(Br), n = 1, r = gv[0], o = [r]; n < e; ++n) i = gv[n], jr(r, i[0]) || jr(r, i[1]) ? (Yr(r[0], i[1]) > Yr(r[0], r[1]) && (r[1] = i[1]), Yr(i[0], r[1]) > Yr(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
        ...
        l_ = function(t) {
            ...
            var n = Nv,
                ...
                r = Av,
                i = n * n + e * e + r * r;
            return i < 1e-12 && (n = Tv, e = kv, r = Sv, xv < 1e-6 && (n = bv, e = wv, r = Mv), i = n * n + e * e + r * r, i < 1e-12) ? [NaN, NaN] : [Hv(e, n) * Iv, gr(r / Qv(i)) * Iv]
        },
        h_ = function(t) {
            return function() {
                return t
    ...
    var d_, v_, __, g_, y_, m_, x_, b_, w_, M_, T_, k_ = function(t) {
        ...
        S_ = function() {
            ...
            function n() {
                var t = i.apply(this, arguments),
                    n = o.apply(this, arguments) * Yv,
                    c = u.apply(this, arguments) * Yv;
            ...
            return n.center = function(t) {
                return arguments.length ? (i = "function" == typeof t ? t : h_([+t[0], +t[1]]), n) : i
            }, n.radius = function(t) {
        ...
        L_ = function(t, n) {
            ...
            for (var a = 0, c = t.length; a < c; ++a)
                if (f = (s = t[a]).length)
                    for (var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + Ov, d = Gv(p), v = Xv(p), _ = 0; _ < f; ++_, h = y, d = x, v = b, l = g) {
                        var g = s[_],
                            y = g[0],
                            m = g[1] / 2 + Ov,
                            x = Gv(m),
            ...
            var e = t[0] * Yv,
                ...
                _ = d ? function(t) {
                    var n = Gv(t *= d) / v,
                        ...
                        i = e * l + n * p,
                        o = e * a + n * s;
                    return [Hv(i, r) * Iv, Hv(o, Qv(r * r + i * i)) * Iv]
                } : function() {
                    return [e * Iv, r * Iv]
                };
        ...
        cg = {
            ...
            result: function() {
                var t = ag ? [og / ag, ug / ag] : ig ? [eg / ig, rg / ig] : ng ? [K_ / ng, tg / ng] : [NaN, NaN];
            ...
            function i(t) {
                ...
                return {
                    ...
                    point: function(l, h) {
                        var p, d = [l, h],
                            v = r(l, h),
                            _ = c ? v ? 0 : u(l, h) : v ? u(l + (l < 0 ? Uv : -Uv), h) : 0;
        ...
        Sg = function() {
            ...
            return t.invert = function(t) {
                ...
                return i = c.translate(t).clipExtent([
                    ...
                    [r - .425 * e + 1e-6, a + .12 * e + 1e-6],
                    [r - .214 * e - 1e-6, a + .234 * e - 1e-6]
                ]).stream(l), u = f.translate([r - .205 * e, a + .212 * e]).clipExtent([
                    [r - .214 * e + 1e-6, a + .166 * e + 1e-6],
                    [r - .115 * e - 1e-6, a + .234 * e - 1e-6]
                ]).stream(l), n()
    ...
    var sy = function() {
        ...
        py = function() {
            function t(t) {
                return t.x0 = t.y0 = 0, t.x1 = i, t.y1 = o, t.eachBefore(n), u = [0], r && t.eachBefore(ry), t
            }
    ...
    var ky = function(t, n) {
        ...
        Oy = Dy("text/csv", ad),
        Fy = Dy("text/tab-separated-values", hd),
        Iy = Array.prototype,
        Yy = Iy.map,
        By = Iy.slice,
        jy = {
    ...
    var Km = Date.prototype.toISOString ? Ja : t.utcFormat("%Y-%m-%dT%H:%M:%S.%LZ"),
        tx = +new Date("2000-01-01T00:00:00.000Z") ? Qa : t.utcParse("%Y-%m-%dT%H:%M:%S.%LZ"),
        nx = function() {
            return nc(Mm, bm, am, om, rm, nm, Ky, Jy, t.timeFormat).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)])
        },
        ex = function() {
            return nc(Vm, Xm, zm, Am, Nm, km, Ky, Jy, t.utcFormat).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)])
        },
        rx = function(t) {
        ...
        cx = Th($t(300, .5, 0), $t(-240, .5, 1)),
        sx = Th($t(-100, .75, .35), $t(80, 1.5, .8)),
        fx = Th($t(260, .75, .35), $t(80, 1.5, .8)),
        lx = $t(),
        hx = function(t) {
        ...
        Ex = function() {
            function t() {
                var t, s, f = +n.apply(this, arguments),
                    ...
                    h = o.apply(this, arguments) - Sx,
                    p = u.apply(this, arguments) - Sx,
                    d = yx(p - h),
                    v = p > h;
                if (c || (c = t = Re()), l < f && (s = l, l = f, f = s), l > 1e-12)
                    if (d > Nx - 1e-12) c.moveTo(l * xx(h), l * Mx(h)), c.arc(0, 0, l, h, p, !v), f > 1e-12 && (c.moveTo(f * xx(p), f * Mx(p)), c.arc(0, 0, f, p, h, v));
                    else {
                        var _, g, y = h,
                            m = p,
                            x = h,
                            ...
                            k = T > 1e-12 && (i ? +i.apply(this, arguments) : Tx(f * f + l * l)),
                            S = wx(yx(l - f) / 2, +r.apply(this, arguments)),
                            N = S,
                            E = S;
                        if (k > 1e-12) {
                            var A = oc(k / f * Mx(T)),
                        ...
                        if (S > 1e-12) {
                            var q = l * xx(m),
                                ...
                                O = f * Mx(x);
                            if (d < kx) {
                                var F = w > 1e-12 ? lc(z, P, D, O, q, U, L, R) : [L, R],
                                    I = z - F[0],
                                    Y = P - F[1],
                                    B = q - F[0],
                                    j = U - F[1],
                                    H = 1 / Mx(ic((I * B + Y * j) / (Tx(I * I + Y * Y) * Tx(B * B + j * j))) / 2),
                                    X = Tx(F[0] * F[0] + F[1] * F[1]);
            ...
            return t.centroid = function() {
                var t = (+n.apply(this, arguments) + +e.apply(this, arguments)) / 2,
                    r = (+o.apply(this, arguments) + +u.apply(this, arguments)) / 2 - kx / 2;
                return [xx(r) * t, Mx(r) * t]
        ...
        Rx = function() {
            function t(t) {
                var a, c, s, f, l, h = t.length,
                    ...
                    g = Math.min(Nx, Math.max(-Nx, o.apply(this, arguments) - _)),
    ...
    var Ux = function() {
        ...
        Bx = {
            draw: function(t, n) {
                var e = Math.sqrt(n / Yx),
                    r = e * Ix;
                t.moveTo(0, -e), t.lineTo(r, 0), t.lineTo(0, e), t.lineTo(-r, 0), t.closePath()
            }
        },
        jx = Math.sin(kx / 10) / Math.sin(7 * kx / 10),
        Hx = Math.sin(Nx / 10) * jx,
        Xx = -Math.cos(Nx / 10) * jx,
        $x = {
            draw: function(t, n) {
    ...
    var Ob = function() {
            function t(t) {
                return new Ss(t.map(function(r, i) {
                    var o = [Math.round(n(r, i, t) / Ub) * Ub, Math.round(e(r, i, t) / Ub) * Ub];
        ...
        Bb = function() {
            ...
            function s() {
                ...
                if (y.apply(this, arguments)) {
                    ...
                    if (o.wheel) o.mouse[0][0] === s[0] && o.mouse[0][1] === s[1] || (o.mouse[1] = u.invert(o.mouse[0] = s)), clearTimeout(o.wheel);
                        ...
                        if (u.k === c) return;
                        o.mouse = [s, u.invert(s)], Fh(this), o.start()
                    }
            ...
            function f() {
                ...
                if (!g && y.apply(this, arguments)) {
                    var o = a(this, arguments),
                        u = _l(t.event.view).on("mousemove.zoom", n, !0).on("mouseup.zoom", e, !0),
                        c = qf(this);
                    bl(t.event.view), Cs(), o.mouse = [c, this.__zoom.invert(c)], Fh(this), o.start()
                }
            }
            ...
            function h() {
                if (y.apply(this, arguments)) {
                    var n, e, r, i, o = a(this, arguments),
                        ...
                        c = u.length;
                    for (Cs(), e = 0; e < c; ++e) r = u[e], i = yl(this, u, r.identifier), i = [i, this.__zoom.invert(i), r.identifier], o.touch0 ? o.touch1 || (o.touch1 = i) : (o.touch0 = i, n = !0);
            ...
            return n.transform = function(t, n) {
                ...
                emit: function(t) {
                    E(new Ns(n, t, this.that.__zoom), C.apply, C, [t, this.that, this.args])
                }
            }, n.filter = function(t) {
